...
Tous les informations concernant le cours y seront publiés. Les diapositives, les travaux pratiques, le plan de cours et les dates importantes.
...
Il s'agit d'un court travail de 1-2 pages qui permettra de vous familiariser avec les outils de travail collaboratif utilisés dans le cours et de s'assurer que vous êtes prêt à commencer le cours.
...
Les lectures pour ce cours, bien que fortement recommandées, ne sont pas obligatoires.
...
- Montrer comment l'apprentissage automatique supervisé peut être utilisé pour prédire un résultat à partir de variables de sondage
...
- Lire le chapitre 8.1 : The Basics of Decision Trees 
