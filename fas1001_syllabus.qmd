...
**15% des points** seront alloués à **la participation en classe**. L'entraide entre les étudiant-es est encouragée (évaluation et correction de code sur `GitHub` ou lors des ateliers).

## Travaux pratiques (30/100)
...
- Introduction à `GitHub` (**10 points**)
...
**35% des points** seront alloués à **votre travail de session individuel pouvant aller de 10 à 15 pages**. 
...
- Participation en classe: **15 points**

- Travaux pratiques: **30 points**

- Travail de mi-session: **20 points**

- Travail de session: **35 points**
