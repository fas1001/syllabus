...
**Local de cours:** Pavillon Jean Brillant, local B-4290
...
**30% des points** seront alloués aux **quizz en classe**. 
Les étudiant-es devront compléter deux quizz de 1h00 sur leurs ordinateurs qui permettront d'évaluer leurs connaissances à propos de la matière apprise en classe. 
...
- Fournir un retour personnalisé sur le TP 1 et le quizz 1
